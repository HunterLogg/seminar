...
<body>
					...
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="/oauth/redirect"><i class="fa fa-dribbble"></i></a></li>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="/cart"><i class="fa fa-shopping-cart"></i> Cart ({{isset($cart_count) ? $cart_count : 0}})</a></li>
								<li><a href="/order"><i class="fa fa-truck"></i> Order</a></li>
								@if (Route::has('login'))
            					    @auth
	...
	<link rel="stylesheet" href="{{ asset('back-end/css/jquery-confirm.min.css')}}">
